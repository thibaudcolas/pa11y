...
((exports => {
	...
	/**
	 * Initialize Pa11y results for the current page.
	 * @public
	 * @param {Object} options - Options to use when initializing.
	 * @returns {Promise} Returns a promise which resolves with the test results object.
	 */
	...
	/**
	 * Run Pa11y on the current page, with the given runner.
	 * @public
	 * @param {Object} options - Options to use when running tests.
	 * @param {string} runnerName - Name of the runner to execute.
